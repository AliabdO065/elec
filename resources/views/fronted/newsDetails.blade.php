...
@section('content')
    ...
    <link rel="alternate" type="application/json+oembed"
        href="{{ asset('fronted/wp-json/oembed/1.0/embedbb01.json?url=https%3A%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fsmart-cities-of-tomorrow%2F') }}" />
    <link rel="alternate" type="text/xml+oembed"
        href="{{ asset('fronted/wp-json/oembed/1.0/embed58d5?url=https%3A%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fsmart-cities-of-tomorrow%2F&amp;format=xml') }}" />
    <meta name="generator"
    ...
    <body
        class="post-template-default single single-post postid-5652 single-format-standard qodef-qi--no-touch qi-addons-for-elementor-1.6.5 elementor-default elementor-kit-8">
                ...
                <div class="layout-medium" style="margin-top: 100px;">
                    <div class="post-header post-header-classic is-cat-link-borders-light is-cat-link-rounded">
                            ...
                            <div class="entry-meta above-title">
                                <span class="cat-links">
                                    <span class="prefix">
                                        ...
                                        rel="category tag">{{ $item['category'] }}</a> </span> <!-- .cat-links -->
                            @else
                                ...
                                <span class="entry-share">
                                    ...
                                    <span class="entry-share-wrap">
                                        <span class="entry-share-inner-wrap">
                                            <a class="share-facebook" rel="nofollow" target="_blank"
                                                href="https://www.facebook.com/sharer.php?u=https://themes.pixelwars.org/energify/demo-01/smart-cities-of-tomorrow/&amp;t=Solar%20Energy%20in%20Developing%20Countries"
                                                title="Share this post on Facebook">Facebook</a>

                                            <a class="share-twitter" rel="nofollow" target="_blank"
                                                href="https://twitter.com/intent/tweet?text=Currently%20reading:%20'Solar%20Energy%20in%20Developing%20Countries'%20on%20https://themes.pixelwars.org/energify/demo-01/smart-cities-of-tomorrow/"
                                                title="Tweet this post to your followers">Twitter</a>

                                            <a class="share-pinterest" rel="nofollow" target="_blank"
                                                href="https://pinterest.com/pin/create/button/?url=https://themes.pixelwars.org/energify/demo-01/smart-cities-of-tomorrow/&amp;media=https://themes.pixelwars.org/energify/demo-01/wp-content/uploads/sites/2/2023/07/house-roof-with-photovoltaic-modules-historic-farm-house-with-modern-solar-panels-roof-wall.jpg&amp;description=Solar%20Energy%20in%20Developing%20Countries"
                                                title="Pin it">Pinterest</a>

                                            <a class="share-mail" rel="nofollow" target="_blank"
                                                href="mailto:?subject=I%20wanted%20you%20to%20see%20this%20post&#038;body=Check%20out%20this%20post:%20Solar%20Energy%20in%20Developing%20Countries%20-%20https://themes.pixelwars.org/energify/demo-01/smart-cities-of-tomorrow/"
                                                title="Email this post to a friend">Email</a>
                        ...
                        <div class="featured-image">
                            <img width="1920" height="1280" src="{{ asset($item['img']) }}"
                                class="attachment-energify_image_size_7 size-energify_image_size_7 wp-post-image"
                                alt="" decoding="async" srcset="{{ asset($item['img']) }}"
                    ...
                    <div id="primary" class="content-area ">
                        <div id="content" class="site-content" role="main">
                            <article id="post-5652"
                                class="post-5652 post type-post status-publish format-standard has-post-thumbnail hentry category-insights is-cat-link-borders-light is-cat-link-rounded">
                                <div class="hentry-wrap">
                                    <div class="entry-content">
                                        ...
                                        <figure class="wp-block-image size-large"><img decoding="async" loading="lazy"
                                                width="1024" height="683" src="{{ asset($item['bimg1']) }}"
                                                alt="" class="wp-image-8786"
                                                srcset="{{ asset($item['bimg1']) }}"
                                        ...
                                        <div class="wp-block-columns is-layout-flex wp-container-2">
                                            <div class="wp-block-column is-layout-flow">
                                                ...
                                                <figure class="wp-block-image size-large"><img decoding="async"
                                                        loading="lazy" width="1024" height="597"
                                                        src="{{ asset($item['bimg2']) }}" alt=""
                                                        class="wp-image-8813" srcset="{{ asset($item['bimg2']) }}"
                                                        sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
                                            </div>
                                        </div>
                                ...
                                <div class="share-links">
                                    ...
                                    <a class="share-twitter" rel="nofollow" target="_blank"
                                        href="https://twitter.com/intent/tweet?text=Currently%20reading:%20'Solar%20Energy%20in%20Developing%20Countries'%20on%20https://themes.pixelwars.org/energify/demo-01/smart-cities-of-tomorrow/"
                                        title="Tweet this post to your followers">
                                    ...
                                    <a class="share-mail" rel="nofollow" target="_blank"
                                        href="mailto:?subject=I%20wanted%20you%20to%20see%20this%20post&#038;body=Check%20out%20this%20post:%20Solar%20Energy%20in%20Developing%20Countries%20-%20https://themes.pixelwars.org/energify/demo-01/smart-cities-of-tomorrow/"
                                        title="Email this post to a friend">
                                ...
                                <nav class="nav-single">
                                    @if ($pitem != '')
                                        <div class="nav-previous">
                                            ...
                                            <div class="nav-desc">
                                                <h4>Previous Post</h4>
                                                <a href="{{ route('fronted.newsDetails', $pre) }}" rel="prev"><span
                                                        class="meta-nav">&#8592;</span> {{ $pitem['title'] }}</a>
                                            </div>

                                            <a class="nav-overlay-link" href="{{ route('fronted.newsDetails', $pre) }}"
                                                rel="prev">
                                    ...
                                    @if ($nitem != '')
                                        <div class="nav-next">
                                            ...
                                            <div class="nav-desc">
                                                <h4>Next Post</h4><a href="{{ route('fronted.newsDetails', $next) }}"
                                                    rel="next">{{ $nitem['title'] }}
                                                    <span class="meta-nav">&#8594;</span></a>
                                            </div>


                                            <a class="nav-overlay-link" href="{{ route('fronted.newsDetails', $next) }}"
                                                rel="next">
                                                            ...
                                                            <header class="entry-header">
                                                                <div class="entry-meta">
                                                                    ...
                                                                    @if ($slide['category'] == 'NEWS')
                                                                        <span class="cat-links">
                                                                            <a href="{{ route('fronted.onlynews') }}"
                                                                                rel="category tag">{{ $slide['title'] }}</a>
                                                                        </span> <!-- .cat-links -->
                                                                    @else
                                                                        <span>
                                                                            <a href="{{ route('fronted.onlyinsight') }}"
                                                                                rel="category tag">{{ $slide['title'] }}</a>
                                                                        </span> <!-- .cat-links -->
                                                                    @endif
                                                                </div> <!-- .entry-meta -->
                                                                ...
                                                                <h2 class="entry-title">
                                                                    <a
                                                                        href="{{ route('fronted.newsDetails', $e) }}">{{ $slide['title'] }}</a>
                                                                </h2> <!-- .entry-title -->

                                                                <a class="more-link"
                                                                    href="{{ route('fronted.newsDetails', $e) }}">View
                                                                    Post</a> <!-- .more-link -->
                                                            </header> <!-- .entry-header -->
                                                        </div> <!-- .post-wrap -->
                                                    </div> <!-- .post-thumbnail -->
                                    ...
                                    <form action="{{ route('fronted.news.comment') }}" method="post" id="commentform"
                                        ...
                                        <p class="comment-form-url"><label for="url">Website</label>
                                            <input id="url" name="url" type="url" value=""
                                                size="30" maxlength="200" autocomplete="url" />
                                        </p>
