    ...
    .cat-title .small-link:hover {
        text-decoration: underline;
                            ...
                            <div class="blog-grid-wrap">
                                <div class="blog-stream blog-grid blog-small masonry " data-layout="masonry"
                                    data-item-width="360">
                                    @if (!empty($content[0]))
                                        @foreach ($content as $i => $slides)
                                            ...
                                            <article id="post-5656"
                                                class="post-5656 post type-post status-publish format-standard has-post-thumbnail hentry category-news is-cat-link-borders-light is-cat-link-rounded">
                                                <div class="hentry-wrap">
                                                    <div class="featured-image">
                                                        <a href="{{ route('fronted.newsDetails', $i) }}">
                                                            <img width="550" height="271"
                                                                src="{{ route('fronted.newsDetails', $i) }}"
                                                                class="attachment-energify_image_size_2 size-energify_image_size_2 wp-post-image"
                                                                alt="" decoding="async"
                                            ...
                                            <span class="entry-share-wrap">
                                                <span class="entry-share-inner-wrap">
                                                    <a class="share-facebook" rel="nofollow" target="_blank"
                                                        href="https://www.facebook.com/sharer.php?u=https://themes.pixelwars.org/energify/demo-01/architectural-heritage/&amp;t=Solar%20Energy%20Surpasses%20Milestone"
                                                        title="Share this post on Facebook">Facebook</a>

                                                    <a class="share-twitter" rel="nofollow" target="_blank"
                                                        href="https://twitter.com/intent/tweet?text=Currently%20reading:%20'Solar%20Energy%20Surpasses%20Milestone'%20on%20https://themes.pixelwars.org/energify/demo-01/architectural-heritage/"
                                                        title="Tweet this post to your followers">Twitter</a>

                                                    <a class="share-pinterest" rel="nofollow" target="_blank"
                                                        href="https://pinterest.com/pin/create/button/?url=https://themes.pixelwars.org/energify/demo-01/architectural-heritage/&amp;media=https://themes.pixelwars.org/energify/demo-01/wp-content/uploads/sites/2/2023/07/solar-container-unit-3d-rendering-concept-white-industrial-battery-energy-storage-container-with-mounted-black-solar-panels-situated-fresh-green-grass-late-sunny-weather.jpg&amp;description=Solar%20Energy%20Surpasses%20Milestone"
                                                        title="Pin it">Pinterest</a>

                                                    <a class="share-mail" rel="nofollow" target="_blank"
                                                        href="mailto:?subject=I%20wanted%20you%20to%20see%20this%20post&#038;body=Check%20out%20this%20post:%20Solar%20Energy%20Surpasses%20Milestone%20-%20https://themes.pixelwars.org/energify/demo-01/architectural-heritage/"
                                ...
                                <div class="entry-content">
                                    ...
                                    <p class="more"><a class="more-link"
                                            href="{{ route('fronted.newsDetails', $i) }}">Read More</a></p>
                                </div> <!-- .entry-content -->
                            </div> <!-- .hentry-middle -->
                        </div> <!-- .hentry-wrap -->
                        </article>
