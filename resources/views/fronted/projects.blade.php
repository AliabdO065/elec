...
@section('content')
    ...
    <link rel="alternate" type="application/json+oembed"
        href="{{ asset('fronted/wp-json/oembed/1.0/embed042e.json?url=https:%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fprojects%2F') }}" />
    <link rel="alternate" type="text/xml+oembed"
        href="{{ asset('fronted/wp-json/oembed/1.0/embeda7ff?url=https:%2F%2Fthemes.pixelwars.org%2Fenergify%2Fdemo-01%2Fprojects%2F&amp;format=xml') }}" />
    <meta name="generator"
    ...
    <body
        class="page-template page-template-page_template-portfolio page-template-page_template-portfolio-php page page-id-1002 qodef-qi--no-touch qi-addons-for-elementor-1.6.5 elementor-default elementor-kit-8">
                    ...
                    <div id="primary" class="content-area ">
                        <div id="content" class="site-content" role="main">
                            ...
                            <div class="blog-grid-wrap">
                                <div class="blog-stream blog-grid blog-small portfolio-grid masonry" data-layout="fitRows"
                                    data-item-width="380">
                                    ...
                                    @if (!empty($content[0]))
                                        @foreach ($content as $i => $slides)
                                            ...
                                            <div id="post-3178"
                                                class="post-3178 portfolio type-portfolio status-publish format-standard has-post-thumbnail hentry ">
                                                <div class="hentry-wrap">
                                                    <div class="featured-image">
                                                        <a href="{{ route('fronted.projectDetails', $i) }}">
                                                            <img width="550" height="362"
                                                                src="{{ asset($slide['img']) }}"
                                                                class="attachment-energify_image_size_4 size-energify_image_size_4 wp-post-image"
