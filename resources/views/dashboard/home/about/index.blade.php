            ...
            <div class="page-inner">
                ...
                <form action="{{ route('dashboard.about.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3  form-inline">
                        <input type="text" style="width:70%" class="form-control pr-6" value="{{ $slide['row1'] }}"
                            name="row1">
                        <input type="text" style="width:20%" class="form-control" value="{{ $slide['p1'] }}"
                            name="p1">
                    </div>
                    <div class="mb-3  form-inline">
                        <input type="text" style="width:70%" class="form-control pr-6" value="{{ $slide['row2'] }}"
                            name="row2">
                        <input type="text" style="width:20%" class="form-control" value="{{ $slide['p2'] }}"
                            name="p2">
                    </div>
                    <div class="mb-3  form-inline">
                        <input type="text" style="width:70%" class="form-control pr-6" value="{{ $slide['row3'] }}"
                            name="row3">
                        <input type="text" style="width:20%" class="form-control" value="{{ $slide['p3'] }}"
                            name="p3">
                    </div>
                    ...
                    <div class="mb-3 form-inline">
                        ...
                        <img src="{{ asset($slide['img1']) }}" class="card-img-top" style ="width:100px;margin-left: 20PX;"
                            alt="...">
                    </div>
                    ...
                    <div class="mb-3 form-inline">
                        ...
                        <img src="{{ asset($slide['img2']) }}" class="card-img-top" style ="width:100px;margin-left: 20PX;"
                            alt="...">
                    </div>
                    ...
                    <div class="mb-3 form-inline">
                        ...
                        <img src="{{ asset($slide['img3']) }}" class="card-img-top"
                            style ="width:100px;margin-left: 20PX;" alt="...">
                    </div>


                    <hr style="background-color: yellow; height: 2px;">
                    <button type="submit"
                        style="width: 184px;font-size: 27px;height: 49px;margin-left: 50%;transform: translateX(-50%);"
